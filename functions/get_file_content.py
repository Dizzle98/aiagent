...
schema_get_file_content = {
    ...
    "function": {
        ...
        "description": "Reads a specified file relative to the working directory, providing the content of the file",
        "parameters": {
            "type": "object",
            "properties": {
                "file_path": {
                    "type": "string",
                    "description": "File path to access the contents from, relative to the working directory (default is the working directory itself)",
                },
            },
        },
    },
